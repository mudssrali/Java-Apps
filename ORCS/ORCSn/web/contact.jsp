...
================================================== -->
  <body>
        ...
        <div class="navbar navbar-inverse navbar-static-top" role="navigation">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="controller?action=index">Bootstrap Restaurant</a>
            </div>
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
				  <li><a href="controller?action=index">Home</a></li>
				  <li><a href="controller?action=about">About Us</a></li>
				  <li class="active"><a href="controller?action=contact">Contact</a></li>
	...
	<div class="introSection">
		...
		<div class="col-lg-4">
		<h3>Welcome to ONLINE RESTAURANT COUPON SYSTEM</h3>
		<p>
		Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy 
		text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. 
		It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. <br><br>
